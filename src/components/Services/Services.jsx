...
const services = [
  {
    ...
    description:
      'Premium stainless steel surgical instruments precision-crafted for the operating room. Scalpels, forceps, scissors, retractors, and full surgical sets — autoclavable and ISO certified.',
  ...
  },
  {
    ...
    description:
      'High-grade titanium and stainless steel bone screws, plates, nails, and joint systems engineered for strong, lasting fixation. CE Marked and available in full implant sets.',
    image: '/svc-orthopedic.png',
    color: '#34d399',
  },
  {
    id: 3,
    ...
    description:
      'Modern ICU beds, operation tables, ward furniture, and trolleys built for clinical comfort and durability. Electric, semi-electric, and manual options available internationally.',
  ...
  },
  {
    ...
    description:
      'Reliable diagnostic devices — pulse oximeters, BP monitors, stethoscopes, and patient monitoring systems — trusted across hospitals and clinics in 40+ countries.',
